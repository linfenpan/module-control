...
var fs = require("fs"), minimatch = require("minimatch");
...
var proto = {
	...
	isImage: function(p){
		return minimatch(p, "*.{gif,jpeg,jpg,png,GIF,JPEG,JPG,PNG}", {matchBase: true});
	},
	// 读取文件，转为JSON数据
	readFile2JSON: function(p){
		console.log(this.isExist(p));
		try{
